  ...
  return (
    <div className='h-screen flex flex-col justify-between '>
      <div className='flex justify-between items-center container mx-auto mt-5 px-3 lg:px-0'>
        <Logo />
        <button className='bg-zinc-900 font-body border-zinc-900 border rounded-xl inline-flex items-center justify-center py-3 px-6 text-center text-xs font-medium text-white hover:bg-zinc-800 disabled:bg-gray-3 disabled:border-gray-3 disabled:text-dark-5 md:block hidden'>
          Download
        </button>
